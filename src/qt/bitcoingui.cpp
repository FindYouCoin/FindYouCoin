...
{
    resize(850, 550);
    setWindowTitle(tr("FindYouCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a FindYouCoin address"));
  ...
  blockAction = new QAction(tr("&Block Explorer"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About FindYouCoin"), this);
    aboutAction->setToolTip(tr("Show information about FindYouCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for FindYouCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("FindYouCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("FindYouCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FindYouCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid FindYouCoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::bountySendRequest()
{
    ...
    const QString url (QString("http://faucet.findyoucoin.com/findyoucoin/get/%1")
